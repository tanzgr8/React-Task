      ...
      <div className="container ct">
        <form><div class="mb-3 row">
          ...
          <div className="col-sm-10">
            <input type="text" name="name" className="form-control form-control-sm" onChange={this.handleChange} />
          </div>
        </div>
        <div class="mb-3 row">
        <label className=" col-sm-2 col-form-label" >Country</label>
          <div class="col-sm-10">
          <input t pe="text" name="country"  className="form-control form-control-sm" onChange={this.handleChange}/>
          </div>
        </div>
        <div class="mb-3 row">
          <label className=" col-sm-2 col-form-label">Capital</label>
          <div class="col-sm-10">
            <input type="text" name="capital" className="form-control form-control-sm" onChange={this.handleChange} />
          </div>
        </div>
